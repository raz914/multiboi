function InstructionScreen({ onGotIt }) {
  return (
    <div className="fixed inset-0 z-50 bg-[#2D1C42]">
      <div className="relative bg-white w-full h-full max-w-md mx-auto flex flex-col overflow-hidden">
        ...
        <div className="flex-1 relative">
          ...
          <button
            onClick={onGotIt}
            className="absolute right-16 bottom-48 px-8 py-3 text-white rounded-2xl font-medium transition-all duration-200 hover:shadow-inner transform hover:scale-[1.05] active:scale-[0.95]"
            style={{
              background:
