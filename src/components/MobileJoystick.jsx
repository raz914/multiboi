...
function MobileJoystick() {
  const { isTouchInterface, setMovement } = useInput()
  ...
  return (
    <div className="pointer-events-none fixed bottom-8 left-8 z-20">
      <div
        ref={containerRef}
      ...
      >
        ...
        <div
          ref={knobRef}
          className="absolute left-1/2 top-1/2 h-16 w-16 -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-400/60 shadow-lg shadow-indigo-500/30"
        />
      </div>
    </div>
  )
